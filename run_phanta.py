...
if __name__=="__main__":
    ...
    args.add_argument("-l", "--read_length", help="Read length", type=int, default=150)
    ...
    args.add_argument("-b", "--bac_cov", help="Bacterial coverage threshold", type=float, default=0.01)
    args.add_argument("-v", "--vir_cov", help="Viral coverage threshold", type=float, default=0.1)
    args.add_argument("-e", "--euk_cov", help="Eukaryotic coverage threshold", type=float, default=0)
    args.add_argument("-a", "--arc_cov", help="Archaeal coverage threshold", type=float, default=0.1)
    args.add_argument("-f", "--confidence", help="Kraken2 classiifcation confidence", type=float, default=0.1)
    args.add_argument("-br", "--bracken_filter", help="Bracken reads threshold", type=int, default=10)
    
    args.add_argument("-ng", "--nongzipped", help="Specify if your files aren't gzipped", action="store_false")
    args.add_argument("-k", "--keepintermediate", help="Specify if you want to keep inte files ", action="store_false")
